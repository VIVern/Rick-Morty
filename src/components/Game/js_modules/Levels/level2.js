  ...
  if(waves.wave1 == true){
    monstersGo = setInterval(function(){
      ...
      if(gameState.pause != true && gameState.newLevel != true && waves.tick !=20){
        monsterArray.push(new MonsterSimpleSpeed(ctx,imgMonsterSimpleSpeed,imgMonsterSimpleHit,imgMonsterDeathShooter,canvas.width,randomNumber(0,(canvas.height-imgMonsterShooter.height)),3,0,20,20,1,2));
