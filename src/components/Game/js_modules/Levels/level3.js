  ...
  if(waves.wave1 == true){
    monstersGo = setInterval(function(){
      ...
      if(gameState.pause != true && gameState.newLevel != true && waves.tick !=20){
        monsterArray.push(new MonsterShield(ctx,canvas,imgMonsterShield,imgMonsterShooter,imgMonsterShooterHit,imgBomb,canvas.width,randomNumber(0,(canvas.height-imgMonsterShooter.height)),2,0,30,15,2,1));
